...
class DomainView(MethodView):
        ...
        if can_access:
            ...
            if "application_id" in domain:
                application = application_manager.get(
                    document_id=domain["application_id"]
                )
            ...
            return (
                jsonify({"error": "User does not have permission to view this domain"}),
                400,
            )
    ...
    def put(self, domain_id):
        ...
        if data.get("application"):
            ...
            if not can_access:
                ...
                return (
                    jsonify(
                        {"error": "User does not have permission to update this domain"}
                    ),
                    400,
                )
    ...
    def delete(self, domain_id):
        ...
        if not can_access:
            ...
            return (
                jsonify(
                    {"error": "User does not have permission to delete this domain"}
                ),
                400,
            )
...
class DomainContentView(MethodView):
    ...
    def get(self, domain_id):
        ...
        if not can_access:
            ...
            return (
                jsonify(
                    {"error": "User does not have permission to download this domain"}
                ),
                400,
            )
    ...
    def post(self, domain_id):
        ...
        if not can_access:
            ...
            return (
                jsonify(
                    {"error": "User does not have permission to upload to this domain"}
                ),
                400,
            )
    ...
    def delete(self, domain_id):
        ...
        if not can_access:
            ...
            return (
                jsonify(
                    {
                        "error": "User does not have permission to delete to this domain content"
                    }
                ),
                400,
            )
...
class DomainGenerateView(MethodView):
    ...
    def post(self, domain_id):
        ...
        if not can_access:
            add_user_action(
                f"Generate domain content from template (ACCESS DENIED) - {domain['name']}"
            )
            return (
                jsonify(
                    {
                        "error": "User does not have permission to generate content for this domain"
                    }
                ),
                400,
            )
...
class DomainRedirectView(MethodView):
    ...
    def get(self, domain_id):
        ...
        if not can_access:
            ...
            return (
                jsonify(
                    {
                        "error": "User does not have permission to view redirects for this domain: {domain['name']}"
                    }
                ),
                400,
            )
    ...
    def post(self, domain_id):
        ...
        if not can_access:
            ...
            return (
                jsonify(
                    {
                        "error": "User does not have permission to create redirects for this domain: {domain['name']}"
                    }
                ),
                400,
            )
        ...
        add_user_action(
            f"Add redirect to domain - domain id: {domain_id} - redirect: data['redirect_url']"
        )
        return jsonify(
    ...
    def put(self, domain_id):
        ...
        if not can_access:
            add_user_action(
                f"Update redirects to domain (ACCESS DENIED) - {domain['name']}"
            )
            return (
                jsonify(
                    {
                        "error": "User does not have permission to update redirects for this domain: {domain['name']}"
                    }
                ),
                400,
            )
        ...
        add_user_action(
            f"Update redirect to domain - domain id: {domain_id} - redirect: data['redirect_url']"
        )
        return jsonify(
    ...
    def delete(self, domain_id):
        ...
        if not can_access:
            ...
            return (
                jsonify(
                    {
                        "error": "User does not have permission to delete redirects for this domain: {domain['name']}"
                    }
                ),
                400,
            )
        ...
        add_user_action(
            f"Delete redirect for domain - Domain id: {domain_id} - subdomain: {subdomain}"
        )
        return jsonify(
...
class DomainLaunchView(MethodView):
    ...
    def get(self, domain_id):
        ...
        if not can_access:
            ...
            return (
                jsonify(
                    {
                        "error": "User does not have permission to launch this domain: {domain['name']}"
                    }
                ),
                400,
            )
    ...
    def delete(self, domain_id):
        ...
        if not can_access:
            add_user_action(
                f"Take down a Domain site (ACCESS DENIED) - {domain['name']}"
            )
            return (
                jsonify(
                    {
                        "error": "User does not have permission to take down this domain: {domain['name']}"
                    }
                ),
                400,
            )
...
class DomainRecordView(MethodView):
    ...
    def get(self, domain_id):
        ...
        if not can_access:
            add_user_action(
                f"View domain hosted zone records (ACCESS DENIED) - {domain['name']}"
            )
            return (
                jsonify(
                    {
                        "error": "User does not have permission to view the hosted zone records: {domain['name']}"
                    }
                ),
                400,
            )
    ...
    def get(self, domain_id):
        ...
        if not can_access:
            ...
            return (
                jsonify(
                    {
                        "error": "User does not have permission to categorize the domain: {domain['name']}"
                    }
                ),
                400,
            )
    ...
    def get(self, domain_id):
        ...
        if not can_access:
            ...
            return (
                jsonify(
                    {
                        "error": "User does not have permission to check the category for the domain: {domain['name']}"
                    }
                ),
                400,
            )
