...
driver.find_element(By.ID, "searchInput").send_keys("heal")
...
driver.find_element(By.ID, "id_your_email").send_keys("barry.k.hansen@gmail.com")
driver.find_element(By.ID, "id_confirm_email").send_keys("barry.k.hansen@gmail.com")
get_and_solve("https://urlfiltering.paloaltonetworks.com/")
driver.find_element(By.CSS_SELECTOR, ".btn-primary").click()
